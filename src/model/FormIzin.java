 ...
 */
public class FormIzin extends javax.swing.JFrame {

    private String tanggal;

    /**
     * Creates new form FormIzin
     */
    public FormIzin() {
        initComponents();
        tampil_data();
...
public void autonumber(){
    try {
        ...
        ResultSet rs = stat.executeQuery("SELECT * FROM jam_izin_guru order by no desc");
        if (rs.next()){
...
public void tampil_data(){
    ...
    try {
        ...
        String sql="select *from jam_izin_guru";
...
public void Tampil_Tanggal() {
    ...
    private void initComponents() {
        ...
        KetCombobox = new javax.swing.JComboBox<>();
        ...
        KetCombobox.setBackground(new java.awt.Color(255, 255, 255));
        KetCombobox.setForeground(new java.awt.Color(255, 255, 255));
        KetCombobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--PILIH--", "Izin", "Sakit", "Tanpa Keterangan" }));
        ...
        jLabel9.setText("FORM ABSEN JAM IZIN / SAKIT / TIDAK HADIR");
        ...
        jDesktopPane1.setLayer(KetCombobox, javax.swing.JLayeredPane.DEFAULT_LAYER);
                    ...
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        ...
                        .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                                ...
                                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(bt_clear, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(KetCombobox, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jDesktopPane1Layout.setVerticalGroup(
            ...
            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                ...
                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(KetCombobox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jDesktopPane1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {bt_cetak, bt_clear, bt_hapus, bt_simpan});
    ...
    private void bt_cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_cetakActionPerformed
        ...
        try{
            String file = "/laporan/Rekap Absen Jam Izin.jasper";
    ...
    private void bt_cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_cariActionPerformed
        ...
        try {
            ...
            String sql = "Select * from jam_izin_guru where no='"+txtCari.getText()+"' or nama='"+txtCari.getText()+"'";
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            ResultSet rs = pst.executeQuery(sql);
            if (rs.next())
            {
    ...
    private void bt_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_hapusActionPerformed
        ...
        try{
            java.sql.Connection conn=(java.sql.Connection)model.koneksi.koneksiDB();
            String sql = "delete from jam_izin_guru where no='"+no.getText()+"' ";
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
    ...
    private void bt_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_simpanActionPerformed
        // TODO add your handling code here:
        try{
            String sql="insert into jam_izin_guru values('"
            +no.getText()+"','"
            +nip.getText()+"','"
            +nama.getText()+"','"
            +tanggal+"','"
    ...
    private void bt_clearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_clearActionPerformed
        ...
        jabatan.setText("");
        KetCombobox.setSelectedIndex(-1);
        txtCari.setText("");
        nip.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormIzin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> KetCombobox;
